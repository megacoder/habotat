...
class AdapterChooserDialog extends ComponentDialog
  {
  ...
  AdapterChooserDialog(Frame parent)
    {
    super(parent, loc.getMessage("window.title.select_account_type"), true,
          true);
    
    setComment(loc.getMessage("window.comment.select_account_type"));
    }
  ...
  protected Component buildDialogUI()
    ...
    KListModel pluginModel = HabotatGUI.server.getAdapters();
